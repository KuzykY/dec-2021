...
// for (let arrayElement of simpsons) {
//     let div=document.createElement('div');
//     div.classList.add('member')
//     div.innerText=`NAME-${arrayElement.name} SURNAME-${arrayElement.surname} AGE-${arrayElement.age} INFO-${arrayElement.info}`
...
//     let courses=document.createElement('curses');
//     let titleElement=document.createElement('h2');
//     courses.innerText=coursesArrayElement.title;
//     let monthDurationEl=document.createElement('div');
//     monthDurationEl.innerText=coursesArrayElement.monthDuration;
//     let hourDurationEl=document.createElement('div');
//     hourDurationEl.innerText=coursesArrayElement.hourDuration;
...
//         modulesEl.append(modules)
//     }
//     courses.append(titleElement,monthDurationEl,hourDurationEl,modulesEl);
